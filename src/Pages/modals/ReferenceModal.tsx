...
interface ModalProps {
    ...
    setRfModal:React.Dispatch<React.SetStateAction<boolean>>;
}

const MateModal: React.FC<ModalProps> = ({ selectedUserList, setSelectedUserList,setRfModal }) => {
        ...
        <div className="modal_Back">
            <div className="Mate_modal_content">
                <div className="Mate_modal_btns">
                    <button onClick={()=>{setRfModal(prev=>!prev)}}>x</button>
                </div>
